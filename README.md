...
抽選応募フォームの入力補助Chrome拡張です。レビュー候補版 **0.9.8.2 / Phase 1.1**。
...
[Phase 1.1の安全境界・制限](docs/PHASE11.md)、[テスト結果](docs/TEST_RESULTS.md)、[統合元とChrome読み込み元の確認方法](docs/PHASE01.md)を参照してください。
